...
// 1024 px desktop for the Servers table, whose columns fold by width, and the routing rules table.
...
export default defineConfig({
  ...
  projects: [
    ...
    { name: "laptop", testMatch: /(nodes|tunnel)\.spec\.ts$/, use: { ...devices["Desktop Chrome"], viewport: { width: 1024, height: 768 } } },
  ],
  webServer: {

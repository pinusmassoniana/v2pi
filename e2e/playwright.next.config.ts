...
// 1024 px desktop for the Servers table, whose columns fold by width.
...
export default defineConfig({
  ...
  projects: [
    ...
    { name: "laptop", testMatch: /nodes\.spec\.ts$/, use: { ...devices["Desktop Chrome"], viewport: { width: 1024, height: 768 } } },
  ],
  webServer: {
